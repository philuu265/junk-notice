...
angular.module("MyMod").directive("pleasematchthis", function () {
  ...
  // $httpProvider
  $httpProvider.interceptors.push(["$scope", function ($scope) {
    a
  }]);
  $httpProvider.responseInterceptors.push(["$scope", function ($scope) {
    a
  }], ["a", "b", function (a, b) {
    b
  }], function () {
  ...
  $stateProvider.state("myState", {
    ...
    params: {
      ...
      inValue: {
        value: ["$scope", function ($scope) {
        }], notThis: function ($scope) {
        }
      },
    },
    views: {
  ...
  $urlRouterProvider.otherwise("", function (a) {
    a;
  });
  $urlRouterProvider.rule(function (a) {
    a;
  }).anything().when("/", ["$location", function ($location) {
    a;
  }]);
...
foobar.irrespective("dontmatchthis", function () {
  ...
  $urlRouterProvider.rule(function (a) {
    a;
  }).anything().when("/", function ($location) {
    a;
  });
...
/* @ngInject */
var foo11 = function ($scope) {
};
foo11.$inject = ["$scope"];
/* @ngInject */
var foo12 = function ($scope) {
};
foo12.$inject = ["$scope"];
/* @ngInject */
var foo13 = function ($scope) {
}
foo13.$inject = ["$scope"];
/* @ngInject */
var foo14 = function ($scope) {
}
foo14.$inject = ["$scope"];
